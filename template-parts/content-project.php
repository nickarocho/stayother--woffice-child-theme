...
//also addition on the <li> line: addition of projectsID class
//SO addition (really: change) ends after <li> opening tag
?>

<li class="box content <?php echo (isset($archived_class)) ? $archived_class : ''; ?> projects<?php echo $project_post_id; ?>">
	<div class="intern-padding">
		...
		<div class="text-right">
			...
			<?php if(current_user_can('manage_options') ){ ?>
				<button type="button" class="btn btn-default" data-toggle="modal" data-target="#exampleModalCenter<?php echo $project_post_id; ?>">
					Duplicate Project
				</button>
				
				<?php so_duplication_modal($project_post_id); ?>
				<?php so_modal_dates($project_post_id); ?>
			<?php } ?>
